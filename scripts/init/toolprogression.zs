...
toolLevels[0].harvestLevelHead(0 as int);
toolLevels[1].harvestLevelHead(1 as int);
toolLevels[2].harvestLevelHead(2 as int);
toolLevels[3].harvestLevelHead(3 as int);
toolLevels[4].harvestLevelHead(4 as int);
toolLevels[5].harvestLevelHead(5 as int);
toolLevels[6].harvestLevelHead(6 as int);
toolLevels[7].harvestLevelHead(7 as int);
toolLevels[8].harvestLevelHead(8 as int);
toolLevels[9].harvestLevelHead(9 as int);
toolLevels[10].harvestLevelHead(10 as int);
